---
title: "Class 1: Fundamentals of probability and statistical inference"
...
- When we ask Excel for the p-value `=NORM.S.DIST(-0.9258,TRUE)+(1-NORM.S.DIST(0.9258,TRUE))` we get the actual, correct result of `r pnorm(-.9258)+(1-pnorm(.9258))`. Good times. Until next week!
Test
...
Decision from sample |Null hypothesis is actually **TRUE**    |Null hypothesis is actually **FALSE**
---------------------|----------------------------------------|----------------------------------------------------------
Reject $H_0$"        | **Type I error**. Probability: $\alpha$|Correct rejection. Probability: $1~-~\beta=$**power** 
"Do not reject $H_0$"| Correct failure to reject: Probability: $1 - \alpha$    |**Type II error**. Probability: $\beta$ 
...
- I took this data set from Andy Johnson, hence the colourful topic (and the absence of cats).
...
- Make a histogram and a means plot
...
Now: report it
==========================================================
- You'll do this in your homework assignment (but I'll give you an example later).
...
- Shapiro-Wilk test (you can do do this one in SPSS)
...
==============================================================
- Watch Andy Johnson's video on myBU and follow along with the data set.

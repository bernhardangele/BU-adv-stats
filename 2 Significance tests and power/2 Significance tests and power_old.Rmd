...
run_simulation <- function(sample_size = 100, 
  ...
  {
require(data.table)
bind_rows(replicate(number_of_simulations, 
...
- If you haven't done it before, now is a really good time to watch (at the very least) the first 7 minutes of [Julian Parris' video](https://www.youtube.com/watch?v=Juo5NJSHlMM) (see myBU).
...
=============================================================
- The main problem here is that we now have *two* random variables: one is our $z$ value, the other one is the $\chi^2$ value 
